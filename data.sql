...
(VALUES
  ('Kelly', 'Title 1', 'Content of blog post the best pizza.', 'Books', '2014-4-30'),
  ('Chris', 'Title 2', 'Content of blog post tshirts are dumb.', 'Music', '2014-4-12'),
  ('Kim', 'Title 3', 'Content of blog post the secret to life.', 'Technology', '2014-4-2'),
  ('Jack', 'Title 4', 'Content of blog post about god.', 'Music', '2014-4-3'),
  ('Jill', 'Title 5', 'Content of blog post about dogs.', 'Technology', '2014-1-30'),
  ('Went', 'Title 6', 'Content of blog post about the best fishing holes.', 'Music', '2014-1-30'),
  ('Hill', 'Title 7', 'Content of blog post whoa.', 'Technology', '2014-4-11'),
...
(VALUES
  ...
  ('Stevie', 'Title 36', 'Random comments of blog post car stuff is good.', '2014-2-14'),
